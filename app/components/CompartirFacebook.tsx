...
export default function CompartirFacebook() {
  function compartir() {
    const url = window.location.href;
    const shareUrl = `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(url)}`;
    window.open(shareUrl, "_blank", "width=600,height=420,noopener,noreferrer");
  }

  return (
    <button type="button" className="compartir-fb-btn" onClick={compartir}>
